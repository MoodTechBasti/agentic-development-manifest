...
- Promoted `docs/SAAS_FOUNDATION_BLUEPRINT.md` from early blueprint to Phase 2 SaaS Foundation Standard.
...
- Added `docs/decisions/ADR-20260708-saas-foundation-standard.md` to record the accepted Phase 2 architecture decision.
