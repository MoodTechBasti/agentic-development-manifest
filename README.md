...
- `docs/SAAS_FOUNDATION_BLUEPRINT.md` — technischer SaaS Foundation Standard
...
- `docs/decisions/ADR-20260708-saas-foundation-standard.md` — SaaS Foundation Standard architecture decision
...
v0.19 Draft. Project-owned memory, Agent Registry, Handover Automation, and SaaS Foundation Standard architecture are accepted. The next major block is Phase 3 AI Foundation Standard.
