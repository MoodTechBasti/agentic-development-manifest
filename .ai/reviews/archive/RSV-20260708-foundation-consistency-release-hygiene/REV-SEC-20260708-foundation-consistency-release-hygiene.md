...
Reviewed security impact of the v0.25 documentation, release hygiene, ruleset audit, review metadata, stable reviewed-code SHA ADR status normalization, and non-scope boundaries.
...
- Strengths: Stable reviewed-code SHA behavior is now marked accepted rather than proposed.
