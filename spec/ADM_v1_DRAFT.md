...
Ein ADM-konformer Master Prompt muss mindestens folgende Bereiche entscheiden oder operationalisieren:
...
- Die notwendige Initialisierung (Lese-Reihenfolge der Doku, Master Prompt Standard und Agent Registry).
